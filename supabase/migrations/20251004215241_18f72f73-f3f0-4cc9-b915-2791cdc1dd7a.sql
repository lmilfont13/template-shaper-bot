...
DROP POLICY IF EXISTS "Only admins can create templates" ON public.document_templates;
DROP POLICY IF EXISTS "Only admins can update templates" ON public.document_templates;
DROP POLICY IF EXISTS "Only admins can delete templates" ON public.document_templates;
...
-- Drop existing policies on generated_documents
...
DROP POLICY IF EXISTS "Admins can view all documents" ON public.generated_documents;
DROP POLICY IF EXISTS "Users can view their own documents" ON public.generated_documents;
DROP POLICY IF EXISTS "Authenticated users can create documents" ON public.generated_documents;
DROP POLICY IF EXISTS "Admins can update all documents" ON public.generated_documents;
DROP POLICY IF EXISTS "Admins can delete all documents" ON public.generated_documents;

-- Add user_id to generated_documents
