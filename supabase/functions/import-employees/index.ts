...
Deno.serve(async (req) => {
    ...
    try {
        ...
        const externalUrl = Deno.env.get('EXTERNAL_SUPABASE_URL') || 'https://bunnclexcjutrltuybam.supabase.co';
        const externalKey = Deno.env.get('EXTERNAL_SUPABASE_ANON_KEY') || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJ1bm5jbGV4Y2p1dHJsdHV5YmFtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzEyMDQ3OTUsImV4cCI6MjA4Njc4MDc5NX0.zCdmX5a7IsEFn0scFo_6e10-kPHeDGHOaiBzC_O4Ulk';
